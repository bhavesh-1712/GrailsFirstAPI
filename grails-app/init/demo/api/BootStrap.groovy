...
class BootStrap {
    ...
    def init = { servletContext ->
        if(City.count() < 1){
            ...
            def student = new Student(gr_no: 22020177, roll_no: 333076, first_name: 'ABC', middle_name: 'LMN', last_name: 'XYZ',age: 19, mobile_no: 8623041313, email: 'abc.xyz@gmail.com')
